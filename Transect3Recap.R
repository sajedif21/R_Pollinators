...
for.net.data  <- read.xlsx("final data.xls", sheetName = "Transect3")
...
complete.network2 <- complete.network[1:4, 2:3] ; dim (complete.network2)
rownames(complete.network2) <- c("Ageratina pseudochilca", "Ageratina sp.", "Dendrophorbium","Ilex")
